    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Encode and decode URL strings and query parameters.</p>
        </div>
          ...
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex rounded-lg border overflow-hidden">
                <button onClick={() => setMode("encode")} className={`px-3 py-1 text-sm ${mode === "encode" ? "bg-green-600 text-white" : "bg-white text-gray-600"}`}>Encode</button>
                <button onClick={() => setMode("decode")} className={`px-3 py-1 text-sm ${mode === "decode" ? "bg-green-600 text-white" : "bg-white text-gray-600"}`}>Decode</button>
              </div>
            </div>
            <Input
              value={input}
